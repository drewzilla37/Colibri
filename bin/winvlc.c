...
# define PROCESS_DEP_ENABLE 1
    ...
    if (vlc != NULL)
    {
        libvlc_set_app_id (vlc, "org.colibri.Colibri", PACKAGE_VERSION,
                           "Colibri");
        libvlc_set_user_agent (vlc, "Colibri", "Colibri/"PACKAGE_VERSION);
        ...
        MessageBox (NULL, TEXT("Colibri could not start.\n"
