...
void FirstRun::buildPrivDialog()
{
    ...
    QLabel *text = new QLabel( qtr(
        "<p>In order to protect your privacy, <i>Colibri</i> "
        "does <b>not</b> collect personal data or transmit them, "
        "not even in anonymized form, to anyone."
        "</p>\n"
        "<p>Nevertheless, <i>Colibri</i> is able to automatically retrieve "
        ...
        "entities. Therefore <i>Colibri</i> requires your express "
        "consent to access the Internet automatically."
        "</p>\n"
        ) );
